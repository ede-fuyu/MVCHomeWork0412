namespace MVC5HomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static VW_CompanyListRepository GetVW_CompanyListRepository()
		{
			var repository = new VW_CompanyListRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VW_CompanyListRepository GetVW_CompanyListRepository(IUnitOfWork unitOfWork)
		{
			var repository = new VW_CompanyListRepository();
		...
		public static VW_CompanyList_2Repository GetVW_CompanyList_2Repository()
		{
			var repository = new VW_CompanyList_2Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static VW_CompanyList_2Repository GetVW_CompanyList_2Repository(IUnitOfWork unitOfWork)
		{
			var repository = new VW_CompanyList_2Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
